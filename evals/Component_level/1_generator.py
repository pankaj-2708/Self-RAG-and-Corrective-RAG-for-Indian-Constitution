...
if not params["enabled"]:
    print(
        "Standalone generator evaluation is disabled. Set 'enabled' to True in params.yaml to enable it."
    )
...
embeddings = BedrockEmbeddings(
    model_id=params["embeddings"]["model_name"], region_name=params["models"]["region"]
)
